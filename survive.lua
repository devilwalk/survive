...
GameConfig.mMonsterLibrary = {
    {
        mModel = "character/v3/Pet/CAITOUBB/CAITOUbb.x",
        mModelScaling = 2,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
    ...
    {
        mModel = "character/v3/Pet/CTBB/ctbb_LOD15.x",
        mModelScaling = 2,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
    ...
    {
        mModel = "character/v3/Pet/HGS/HGS_LOD15.x",
        mModelScaling = 2,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 17 and level <= 24 then
                return true
            end
        end,
        mName = "皇冠蛇宝宝"
    ...
    {
        mModel = "character/v3/Pet/MFBB/MFBB_LOD15.x",
        mModelScaling = 2,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 25 and level <= 32 then
                return true
            end
        end,
        mName = "蜜蜂宝宝"
    ...
    {
        mModel = "character/v3/Pet/MGBB/mgbb_LOD15.x",
        mModelScaling = 2,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 33 and level <= 40 then
                return true
            end
        end,
        mName = "蘑菇宝宝"
    ...
    {
        mModel = "character/v3/Pet/PP/PP_LOD5.x",
        mModelScaling = 2,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 41 and level <= 48 then
                return true
            end
        end,
        mName = "PP机器人"
    ...
    {
        mModel = "character/v3/Pet/SJTZ/SJTZ_LOD05.x",
        mModelScaling = 2,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 49 and level <= 56 then
                return true
            end
        end,
        mName = "小精灵宝宝"
    ...
    {
        mModel = "character/v3/Pet/XGBB/XGBB_LOD5.x",
        mModelScaling = 2,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 57 and level <= 64 then
                return true
            end
        end,
        mName = "西瓜宝宝"
    ...
    {
        mModel = "character/v3/Pet/HDL/HDL_LOD15.x",
        mModelScaling = 2,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 65 and level <= 72 then
                return true
            end
        end,
        mName = "花朵兰宝宝"
    ...
    {
        mModel = "character/v3/Pet/YYCZ/yycz_LOD5.x",
        mModelScaling = 2,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 73 and level <= 80 then
                return true
            end
        end,
        mName = "音乐机器人"
    ...
    {
        mModel = "character/v5/02animals/DragonBaby/DragonBabyGreen/DragonBabyGreen.x",
        mModelScaling = 2,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 81 and level <= 88 then
                return true
            end
        end,
        mName = "绿龙宝宝"
    ...
    {
        mModel = "character/v5/02animals/DragonBaby/DragonBabyOrange/DragonBabyOrange.x",
        mModelScaling = 2,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 89 and level <= 96 then
                return true
            end
        end,
        mName = "橙龙宝宝"
    ...
    {
        mModel = "character/v5/02animals/DragonBaby/DragonBabyYellow/DragonBabyYellow.x",
        mModelScaling = 2,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 97 and level <= 104 then
                return true
            end
        end,
        mName = "黄龙宝宝"
    ...
    {
        mModel = "character/v3/Npc/shitouren/shitouren.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 105 and level <= 112 then
                return true
            end
        end,
        mName = "石头人"
    ...
    {
        mModel = "character/v3/GameNpc/TZMYS/TZMYS.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
    ...
    {
        mModel = "character/v5/02animals/Pig/Pig_V1.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 121 and level <= 128 then
                return true
            end
        end,
        mName = "猪战士"
    ...
    {
        mModel = "character/v5/02animals/Pig/Pig_V2.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 129 and level <= 136 then
                return true
            end
        end,
        mName = "猪射手"
    ...
    {
        mModel = "character/v5/02animals/JXRXLG/JXRXLG.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 137 and level <= 144 then
                return true
            end
        end,
        mName = "机械人"
    ...
    {
        mModel = "character/v5/01human/SmallWindEagle/SmallWindEagle.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 145 and level <= 152 then
                return true
            end
        end,
        mName = "小风鹰"
    ...
    {
        mModel = "character/v5/02animals/SophieDragon/SophieDragon.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 153 and level <= 160 then
                return true
            end
        end,
        mName = "索菲龙"
    ...
    {
        mModel = "character/v5/02animals/XiYiJinJiaoLong/XiYiJinJiaoLong.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 161 and level <= 168 then
                return true
            end
        end,
        mName = "蜥蜴金蛟龙"
    ...
    {
        mModel = "character/v5/06quest/DisorderRobot/DisorderRobot.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 169 and level <= 176 then
                return true
            end
        end,
        mName = "无序机器人"
    ...
    {
        mModel = "character/v5/02animals/FireBon/FireBon.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 177 and level <= 184 then
                return true
            end
        end,
        mName = "冰魔"
    ...
    {
        mModel = "character/v5/01human/Dragon/Dragon.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 185 and level <= 192 then
                return true
            end
        end,
        mName = "龙"
    ...
    {
        mModel = "character/v5/01human/Messenger/Messenger.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 193 and level <= 200 then
                return true
            end
        end,
        mName = "蘑菇妖"
    ...
    {
        mModel = "character/v3/GameNpc/XRKZS/XRKZS.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 201 and level <= 208 then
                return true
            end
        end,
        mName = "熊人战士"
    ...
    {
        mModel = "character/v3/GameNpc/BZL/BZL.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 209 and level <= 216 then
                return true
            end
        end,
        mName = "冰紫龙"
    ...
    {
        mModel = "character/v3/GameNpc/FEILONG/FEILONG.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 217 and level <= 224 then
                return true
            end
        end,
        mName = "飞龙"
    ...
    {
        mModel = "character/v3/GameNpc/HUAYAO/HUAYAO.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 225 and level <= 232 then
                return true
            end
        end,
        mName = "花妖"
    ...
    {
        mModel = "character/v5/02animals/WhiteDragon/WhiteDragon.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 233 and level <= 240 then
                return true
            end
        end,
        mName = "白龙"
    ...
    {
        mModel = "character/v5/02animals/BlueDragon/BlueDragon.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 241 and level <= 248 then
                return true
            end
        end,
        mName = "蓝龙"
    ...
    {
        mModel = "character/v5/02animals/CyanDragon/CyanDragon.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 249 and level <= 256 then
                return true
            end
        end,
        mName = "暴龙"
    ...
    {
        mModel = "character/v5/02animals/EpicDragonDeath/EpicDragonDeath.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 257 and level <= 264 then
                return true
            end
        end,
        mName = "死亡龙"
    ...
    {
        mModel = "character/v5/02animals/EpicDragonFire/EpicDragonFire.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 265 and level <= 272 then
                return true
            end
        end,
        mName = "火龙"
    ...
    {
        mModel = "character/v5/02animals/EpicDragonIce/EpicDragonIce.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 273 and level <= 280 then
                return true
            end
        end,
        mName = "冰龙"
    ...
    {
        mModel = "character/v5/02animals/EpicDragonLife/EpicDragonLife.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 281 and level <= 288 then
                return true
            end
        end,
        mName = "生命龙"
    ...
    {
        mModel = "character/v5/02animals/EpicDragonStorm/EpicDragonStorm.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 289 and level <= 296 then
                return true
            end
        end,
        mName = "雷龙"
    ...
    {
        mModel = "character/v5/02animals/GoldenDragon/GoldenDragon_02.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 297 and level <= 304 then
                return true
            end
        end,
        mName = "金属性龙"
    ...
    {
        mModel = "character/v5/02animals/GreenDragon/GreenDragon_02.x",
        mModelScaling = 1,
        mAttackTime = 1,
        mStopTime = 1,
        mAttackRange = 1,
        mLevelEnable = function(level)
            if level >= 305 and level <= 312 then
                return true
            end
        end,
        mName = "绿龙"
                                    ...
                                    Command_Callback,
                                    {
                                        ...
                                        mExecutingCallback = function(command)
                                            ...
                                            elseif self.mMonsterManager:isAllDead() then
                                                self.mPlayerManager:eachPlayer(
                                                    "addMoney",
                                                    GameCompute.computeMatchSuccessMoney(
                                                        self.mProperty:cache().mLevel,
                                                        #self.mPlayerManager.mPlayers
                                                    )
                                                )
                                                self:broadcast(
                                                    "FightSuccess",
                                                    {
                                                        mAddMoney = GameCompute.computeMatchSuccessMoney(
                                                            self.mProperty:cache().mLevel,
                                                            #self.mPlayerManager.mPlayers
                                                        )
                                                    }
                                                                    ...
                                                                    self:setScene(
                                                                        ...
                                                                        function()
                                                                            self.mProperty:safeWrite(
                                                                                "mLevel",
                                                                                self.mProperty:cache().mSwitchLevel or
...
function Host_GamePlayer:onHit(monster)
    ...
    self.mProperty:safeWrite("mHP", math.max(self.mProperty:cache().mHP - hit_value, 0))
